            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    @if (auth()->user()->tipo === "admin")
                        <a href="{{ route('permissions.create') }}" id="boton">Agregar Permiso</a>
                        <br><br>
                    @endif
                            ...
                            <tbody>
                                @foreach($permissions as $permission)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('permissions.edit', $permission->id) }}" class="boton-con-imagen-interna" style="width: 35px; height: 37px">
