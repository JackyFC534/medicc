                        ...
                        <table class="tabla">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('medicos.show', $medico->id) }}" class="boton-con-imagen-interna" style="width: 35px; height: 37px">
                                            <img src="{{ asset('images/ver.png') }}" style="width: 35px; height: 37px">
                                        </a>
                                        <a href="{{ route('medicos.edit', $medico->id) }}" class="boton-con-imagen-interna" style="width: 35px; height: 37px">
